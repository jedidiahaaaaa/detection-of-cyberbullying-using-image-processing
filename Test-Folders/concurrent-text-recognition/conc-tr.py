...
def decode_predictions(scores, geometry, padding):
...
ap.add_argument("-i", "--image", type=str, default="../Text-Recognition/img/telegram.png",
	help="path to input image")
ap.add_argument("-east", "--east", type=str, default="../Text-Recognition/frozen_east_text_detection.pb",
...
(rects, confidences) = decode_predictions(scores, geometry, args["padding"])
...
cv2.imshow("Text Detection", imageCopy)
cv2.waitKey(0)